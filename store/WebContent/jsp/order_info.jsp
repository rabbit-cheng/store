...
<html>
	...
	<%@include file="/jsp/footer.jsp" %>
		...
		<div class="container">
		<form id="orderForm" action="${pageContext.request.contextPath}/OrderServlet?method=payOrder" method="post">
			<div class="row">
			...
			<div>
				<hr/>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="password" name="name" class="form-control" id="inputPassword3" placeholder="请输收货人">
						</div>
					</div>
					<div class="form-group">
						<label for="confirmpwd" class="col-sm-1 control-label">电话</label>
						<div class="col-sm-5">
							<input type="password" name="telephone" class="form-control" id="confirmpwd" placeholder="请输入联系方式">
