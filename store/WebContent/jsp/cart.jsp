	...
	<body>
		...
		<c:if test="${not empty cart.cartItems}">
			...
			<div style="margin-right:130px;">
				...
				登录后确认是否享有优惠&nbsp;&nbsp;
			</em> 赠送积分: <em style="color:#ff6600;">${item.subTotal}</em>&nbsp; 商品金额: <strong style="color:#ff6600;">￥${item.subTotal}元</strong>
				</div>
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					<a href="${pageContext.request.contextPath}/CartServlet?method=clearItem" id="clear" class="clear">清空购物车</a>
...
<script>
	//页面加载完毕之后获取到class的值为delete的元素，为其绑定事件
	$(".delete").click(function(){
		if(confirm("确认删除？")){//确认删除
			//获取到被删除属性的pid
			var pid = this.pid;
